"""Configuration management loaded from the project root `.env` file."""
...
if os.path.exists(project_root_env):
    ...
    # If there is no root `.env`, fall back to environment variables.
...
class Config:
    ...
    # JSON settings - disable ASCII escaping so Unicode is emitted directly.
    JSON_AS_ASCII = False
    ...
    REPORT_STALL_TIMEOUT_SECONDS = float(os.environ.get('REPORT_STALL_TIMEOUT_SECONDS', '30'))
