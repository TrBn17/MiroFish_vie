...
# This needs to run before other imports.
...
def create_app(config_class=Config):
    ...
    # Configure JSON encoding to emit Unicode directly instead of `\uXXXX` escapes.
    ...
    # Only log startup from the reloader child to avoid duplicate messages in debug mode.
    ...
    # Register simulation process cleanup so all simulation processes stop on shutdown.
