"""Retry helpers for API calls such as LLM requests."""
...
def retry_with_backoff(
    ...
    Args:
        ...
        on_retry: Retry callback in the form (exception, retry_count).
...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        """
        Process a batch and retry failed items individually.
