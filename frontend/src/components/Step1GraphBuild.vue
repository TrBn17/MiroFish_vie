    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            The LLM analyzes the documents and simulation requirements, extracts real-world seeds, and automatically generates a suitable ontology structure.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using the generated ontology, the system chunks documents automatically and calls Zep to build a knowledge graph, extract entities and relations, and form temporal memory and community summaries.
          </p>
