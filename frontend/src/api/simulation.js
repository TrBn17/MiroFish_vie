...
/**
 * Realtime retrieval of agent profiles being generated
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Realtime retrieval of simulation config being generated
 * @param {string} simulationId
...
/**
 * Get realtime simulation run status
 * @param {string} simulationId
 */
 ...
 * Used for displaying project history on the home page
