    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a short passage, <span class="highlight-bold">MiroFish</span> can extract real-world seeds and automatically generate a corresponding parallel world with up to <span class="highlight-orange">one million agents</span>. From a “god’s-eye view”, you can inject variables and search for a <span class="highlight-code">“local optimum”</span> under a dynamic environment and complex collective interactions.
            </p>
            <p class="slogan-text">
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            The forecasting engine is standing by. Upload multiple unstructured files to initialize a simulation run.
          </p>
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Seed extraction & memory injection (individual + collective) & GraphRAG build</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Parallel multi-platform simulation & auto-parse forecasting needs & dynamically update temporal memory</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation/forecasting request in natural language (e.g., If Wuhan University announces it will revoke a disciplinary decision against X, what public opinion trend might follow?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate to Process page (use a special ID to indicate a new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  /* 
    ...
    Ensure these fonts are loaded in index.html.
  */
...
.console-box {
  ...
  padding: 8px; /* Inner padding creates the double-border feel */
}
